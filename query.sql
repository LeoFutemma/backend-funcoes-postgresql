...
SELECT COUNT(medicamento) AS "Medicamentos qtd" FROM farmacia;
...
SELECT ROUND(AVG(idade)) AS "Média idade" FROM usuarios WHERE idade >= 18;
...
SELECT COUNT(estoque) AS estoque FROM farmacia WHERE categoria IS NULL;
...
SELECT nome, idade, cadastro FROM usuarios WHERE cadastro BETWEEN '2020-01-01' AND '2020-12-31' ORDER BY cadastro;
