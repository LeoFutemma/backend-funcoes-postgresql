...
:pencil2: Exercício (originalmente desenvolvido em 01 de Junho de 2022) <br>
Exercício proposto pela [Cubos Academy](https://cubos.academy/sucesso), tem como objetivo praticar funções de consulta de SQL com PostgreSQL.
